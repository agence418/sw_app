  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="p-3">
        ...
        {activeTab === 'participants' && <ListParticipantsView />}

        {/* Gestion des visitors */}
        {activeTab === 'visitors' && <ListVisitorsView />}

        {/* Gestion des coachs */}
        {activeTab === 'coaches' && <ListCoachesView />}

        {/* Gestion des participants */}
        {activeTab === 'teams' && <ListTeamsView />}

        {/* Résultats des votes */}
        {activeTab === 'votes' && <VoteResultsView />}

        {/* Calendrier */}
        {activeTab === 'calendrier' && <CalendarView />}

        {/* Gestion des outils */}
        {activeTab === 'outils' && <ManageToolsView />}
