  ...
  const handleGenerateLink = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        alert(_error._error || 'Erreur lors de la génération du lien');
        return;
      }
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (!uploadResponse.ok) {
        const _error = await uploadResponse.json();
        throw new Error(_error._error || "Erreur lors de l'envoi");
      }
      ...
      console.error('Erreur:', _error);
      alert(_error.message || "Erreur lors de l'envoi du fichier");
    } finally {
  ...
  return (
    <div className="bg-white dark:bg-black rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-800">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm">
        Envoyez votre présentation PowerPoint ou PDF avant la deadline. Formats acceptés : .ppt,
        .pptx, .pdf
      </p>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">
          Générez un lien sécurisé pour envoyer votre présentation depuis un ordinateur. Validité :
          6 heures.
        </p>
