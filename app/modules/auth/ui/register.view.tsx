...
export const RegisterView = ({ onBackToLogin }: RegisterViewProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!passwordValidation.isValid) {
      setError(passwordValidation._error);
      setIsLoading(false);
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        setError(data._error || "Une erreur est survenue lors de l'enregistrement");
        return;
      }
          ...
          <div className="bg-white dark:bg-black rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto p-6">
            ...
            <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
              ...
              <p>
                ...
                l'utilisation de la plateforme Startup Weekend en tant que visiteur.
              </p>

              <h4 className="font-semibold text-gray-900">2. Inscription</h4>
              <p>
                L'inscription en tant que visiteur est gratuite et vous permet d'accéder aux
                contenus publics de l'événement Startup Weekend. Vous vous engagez à fournir des
              ...
              <p>
                En tant que visiteur, votre accès peut être limité à certaines fonctionnalités de la
                plateforme. Les organisateurs se réservent le droit de modifier ces accès à tout
                moment.
              </p>
