...
export const ManageToolsView = () => {
  ...
  return (
    <div className="bg-white dark:bg-black rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-800">
            ...
            {editingId === tool.id ? (
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="text-gray-800 dark:text-gray-200 font-medium">{tool.name}</div>
      ...
      {tools.length === 0 && (
        <p className="text-gray-500 dark:text-gray-400 text-center py-4">Aucun outil enregistré</p>
      )}
    </div>
  );
};
