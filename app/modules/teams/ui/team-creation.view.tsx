            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-green-600 focus:border-transparent"
                ...
                <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full bg-gray-50 dark:bg-gray-9000 text-white dark:text-gray-900 py-2 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                    {isSubmitting ? (
                        "Création en cours..."
                    ) : (
