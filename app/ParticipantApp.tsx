      ...
      <main className="p-4 space-y-4">
        ...
        {activeTab === 'accueil' && (
          <>
            ...
            {getCurrentDayOffset(config.event_start_date ?? '2025-09-05T18:00:00') === 2 &&
              currentEvent?.step < 21 && <SendFileComp />}
            {getCurrentDayOffset(config.event_start_date ?? '2025-09-05T18:00:00') === 1 && (
              <ChooseCoachView />
            )}
          </>
        )}
