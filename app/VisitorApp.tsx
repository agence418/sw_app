...
export const VisitorApp = () => {
  ...
  if (getCurrentDayOffset(config.event_start_date ?? '2025-09-05T18:00:00') > 0) {
    return (
      <div className="min-h-screen text-white dark:text-gray-900 bg-green-600 to-cyan-500 flex items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="p-4">
        {/* Page d'accueil */}
        {status.votesAllowed && config.who_can_vote.includes('visitor') ? (
          <VoteView />
        ) : (
